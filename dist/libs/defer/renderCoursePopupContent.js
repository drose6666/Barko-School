...
const preparingForSchool = `
   ...
   <div class="detail-info-item">
      <p class="detail-info-text">За 8 недель мы научим Вашего реденка базовым умениям, которые понадобятся хорошего старта в школьной программе. <strong>Занятия проходят 1 раз в неделю.</strong></p>
   </div>
`
const school = `
   <div class="detail-info-item">
